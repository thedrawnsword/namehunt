...
const PLATFORMS = [
  ...
  // ── Instagram ─────────────────────────────────────────────────────────────
  {
    ...
    check: async n => {
      ...
      const r = await pwCheck(async page => {
        ...
        return res.status() === 200 ? 'taken' : 'unknown';
      }, 20000);
      return r ?? 'unknown';
    }
  },
  ...
  // ── LinkedIn ──────────────────────────────────────────────────────────────
  {
    ...
    check: async n => {
      ...
      if (status === 999 || status === 429) return 'unknown'; // rate limited
      return 'unknown';
    }
  },
  ...
  // ── Pinterest ─────────────────────────────────────────────────────────────
  {
    ...
    check: async n => {
      ...
      return status === 200 ? 'taken' : 'unknown';
    }
  },
  ...
  // ── Tumblr ────────────────────────────────────────────────────────────────
  {
    ...
    check: async n => {
      ...
      return s === 404 ? 'free' : s === 200 ? 'taken' : 'unknown';
    }
  },
  ...
  // ── Medium ────────────────────────────────────────────────────────────────
  {
    ...
    check: async n => {
      const r = await pwCheck(async page => {
        ...
        return res.status() === 200 && c.length > 8000 ? 'taken' : 'unknown';
      });
      return r ?? 'unknown';
    }
  },
  ...
  // ── ArtStation ────────────────────────────────────────────────────────────
  {
    ...
    check: async n => {
      ...
      const r = await pwCheck(async page => {
        ...
        return res.status() === 200 && c.length > 5000 ? 'taken' : 'unknown';
      });
      return r ?? 'unknown';
    }
  },
  ...
  // ── Permanently unknowable — no public profile pages ─────────────────────
  { name: 'WhatsApp', url: n => `https://wa.me/${n}`,                  check: async () => 'unknown' },
  { name: 'WeChat',   url: n => `https://web.wechat.com/${n}`,        check: async () => 'unknown' },
  { name: 'Signal',   url: n => `https://signal.me/#p/${n}`,          check: async () => 'unknown' },
  { name: 'Bumble',   url: n => `https://bumble.com/en/profile/${n}`, check: async () => 'unknown' },
  { name: 'Hinge',    url: n => `https://hinge.co/${n}`,              check: async () => 'unknown' },
  { name: 'Line',     url: n => `https://line.me/ti/p/~${n}`,         check: async () => 'unknown' },
];
